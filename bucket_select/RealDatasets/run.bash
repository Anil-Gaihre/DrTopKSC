...
# declare -a arr=("UK_DrBucket.csv" "kmer_V1r_DrBucket.csv" "KNN_DrBucket.csv" "UK_log" "kmer_V1r_log" "KNN_log" "U_K64" "U_K128" "U_K256" "U_K512")
declare -a arr=("Twitter_DrBucket.csv" "kmer_V1r_DrBucket.csv" "KNN_DrBucket.csv" "Twitter_log" "kmer_V1r_log" "KNN_log" "U_K64" "U_K128" "U_K256" "U_K512")
#UK: 105153953: N =26
